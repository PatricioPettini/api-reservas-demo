...
class UserServiceTest {
    ...
    void setUp() {
        ...
        user1 = new UserSec(1L, "juan", "1234", true, true, true, true, Set.of());
        user2 = new UserSec(2L, "maria", "abcd", true, true, true, true, Set.of());
    }
    ...
    void save_DeberiaGuardarYRetornarUsuario() {
        UserSec newUser = new UserSec(null, "lucas", "pass", true, true, true, true, Set.of());
        UserSec savedUser = new UserSec(3L, "lucas", "pass", true, true, true, true, Set.of());
    ...
    void update_DeberiaGuardarUsuarioActualizado() {
        UserSec updated = new UserSec(1L, "juan_updated", "9999", true, true, true, true, Set.of());
